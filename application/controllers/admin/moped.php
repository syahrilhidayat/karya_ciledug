<?php 
	class Moped extends CI_Controller
	{
		...
		public function index()
		{
			...
			$this->load->view('admin/moped',$data);
		...
		public function tambah_data()
			{
				...
				$gambar_spesifikasi 	= $_FILES['gambar_spesifikasi']['name'];
					...
					$this->model_motor->data_moped($data,'moped');
					redirect('admin/moped/index');
			}
		}
			public function edit($id)
			{
				...
				$data['motor'] = $this->model_motor->edit_moped($where,'moped')->result();
				$this->load->view('templates_admin/header');
				$this->load->view('templates_admin/sidebar');
				$this->load->view('admin/edit_moped',$data);
				$this->load->view('templates_admin/footer'); 
			}
			...
			public function update()
			{
				...
				$where	= array('id_motor'	=> $id);
				$this->model_motor->update_moped($where,$data,'moped');
				redirect('admin/moped/index');
			...
			{
				$where	= array('id_motor'	=> $id);
				$this->model_motor->delete_moped($where,'moped');
				redirect('admin/moped/index');
			}
