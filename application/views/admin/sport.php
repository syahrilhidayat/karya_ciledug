<div class="container-fluid mt-4">
	...
	<?php foreach ($motor as $mtr) : ?>
		<tr>
			...
			<td>
				<?php echo anchor('admin/sport/edit/'.$mtr->id_motor,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?>
			</td>
			<td>
				<?php echo anchor('admin/sport/delete/'.$mtr->id_motor,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url().'admin/sport/tambah_data'; ?>" enctype="multipart/form-data">
