	...
	class Matic extends CI_Controller{
		...
		public function index()
			{
				...
				$this->load->view('admin/matic',$data);
		...
		public function tambah_data()
			{
				...
				$gambar_spesifikasi 	= $_FILES['gambar_spesifikasi']['name'];
					...
					$this->model_motor->data_matic($data,'matic');
					redirect('admin/matic/index');
			}
		}
		public function edit($id)
		{
			$where = array('id_motor'	=> $id);
				...
				$data['motor'] = $this->model_motor->edit_matic($where,'matic')->result();
				$this->load->view('templates_admin/header');
				$this->load->view('templates_admin/sidebar');
				$this->load->view('admin/edit_matic',$data);
				$this->load->view('templates_admin/footer');
		}
		...
		public function update()
		{
			...
			$where = array('id_motor'	=> $id );
			$this->model_motor->update_matic($where,$data,'matic');
			redirect('admin/matic/index');
		}
		public function hapus($id)
		{
			...
			$this->model_motor->delete_matic($where,'matic');
			redirect('admin/matic/index');	
		}
	}